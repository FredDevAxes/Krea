...
namespace Krea.GameEditor.PropertyGridConverters.JointsPropertyConverters
{
    ...
    class PivotPropertyConverter
    {
        ...
        //-------------------Constructeurs-------------------
        //---------------------------------------------------
        public PivotPropertyConverter() { }
        public PivotPropertyConverter(CoronaJointure joint,Form1 MainForm)
        {
        ...
        [Category("Motor Properties")]
        [DescriptionAttribute("The max motor torque.")]
        public double MaxMotorTorque
        {
            get
            {
                return this.jointSelected.maxMotorTorque;
            }

            set
            {
                this.jointSelected.maxMotorTorque = value;
            }
        }
