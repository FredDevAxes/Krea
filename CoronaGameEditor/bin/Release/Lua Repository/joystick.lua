...
function newJoystick( params )
	...
	if params.outerImage and params.outerImage ~= "" then
		local joystickOuter = display.newImageRect( params.outerImage,params.outerRadius *2,params.outerRadius *2 )
		
		joystick:insert( joystickOuter )
		joystick.joystickOuter = joystickOuter
	else
		-- Or Draw Outer Circle
		local joystickOuter = display.newCircle(0, 0 , params.outerRadius )
	...
	if params.innerImage and params.innerImage ~= "" then
		local joystickInner = display.newImageRect( params.innerImage,params.innerRadius *2,params.innerRadius *2 )
		joystick:insert( joystickInner )
		joystick.joystickInner = joystickInner
	else
		-- Or Draw Inner Circle
		local joystickInner = display.newCircle( 0 , 0 , params.innerRadius )
	...
	joystick.x = params.position_x +params.outerRadius
	joystick.y = params.position_y+params.outerRadius
